...
export default function TermsOfUse() {
  return (
    <>
      <div className="flex w-full  text-white  justify-center sm:mt-14">
        <div className="sm:p-5 px-[10%] text-[20px]">
          <h1 className=" text-[40px]">Terms Of Use</h1>
          <br />
          <h2 className="text-[25px]">1.Introduction</h2>
          <br />
          <p>
            Welcome to GMX PAD, owned and operated by GMX PAD Technologies, Inc.
            d/b/a GMX PAD (“GMX PAD,” “we,” “us”, or “our”). <br /> These Terms
            of Service (“Terms”) govern your access to and use of the GMX PAD
          ...
          <p>
            {" "}
            GMX PAD is not a wallet provider, exchange, broker, financial
            institution, money services business, or creditor. GMX PAD provides
            ...
            blockchains. GMX PAD is not party to any agreement between any
            ...
            control for that specific service. GMX PAD reserves the right to
          ...
          <p>
            ...
            identity on GMX PAD. Accordingly, you will need a blockchain address
            ...
            however, if you want to add some flair to your GMX PAD persona, you
            can add additional information, such as a profile picture, to your
            Account. Your Account on GMX PAD will be associated with your linked
            ...
            maintained by, or affiliated with GMX PAD, and GMX PAD does not have
            custody or control over the contents of your wallet and has no
            ability to retrieve or transfer its contents. GMX PAD accepts no
            ...
            related to the Service or your Account (you can contact us via
            social@GMX PAD.io). You also represent and warrant that you will
            comply with all applicable laws (e.g., local, state, federal and
            other laws) when using the Service. Without limiting the foregoing,
            by using the Service, you represent and warrant that: (a) you are
            not located in, ordinarily resident in, or organized under the laws
            of any jurisdiction that is subject to a comprehensive U.S.
            Government embargo (Embargoed Jurisdiction); (b) you are not subject
            to any sanctions administered by an agency of the U.S. Government,
            any other government, or the United Nations (collectively,
            “Sanctions”); (c) you are not owned or controlled, directly or
            indirectly, by any person that is subject to Sanctions, or that is
            located in, ordinarily resident in, or organized under the laws of,
            any Embargoed Jurisdiction; (d) none of your officers, managers,
            ...
            jurisdiction does not violate any applicable laws. GMX PAD may
            ...
            investigate a potential violation of these Terms. In such cases, GMX
            PAD, in its sole discretion, may disable your Account and block your
            ability to access the Service until such additional information and
            documents are processed by GMX PAD. If you do not provide complete
            and accurate information in response to such a request, GMX PAD may
            ...
            or other actions that GMX PAD, in its sole discretion, may elect to
            take. If your Account becomes inactive for six months or longer, as
            determined by GMX PAD in its sole discretion, you understand that
            GMX PAD may disable your Account or reassign your username or
            associated url. We require all users to be at least 18 years old. If
            you are at least 13 years old but under 18 years old, you may only
            use GMX PAD through a parent or guardian’s Account and with their
            approval and oversight. That account holder is responsible for your
            actions using the Account. It is prohibited to use our Service if
          ...
          <p>
            ...
            materials contained therein, including, without limitation, the GMX
            PAD logo and all designs, text, graphics, pictures, data, software,
            sound files, other files, and the selection and arrangement thereof
            are the proprietary property of GMX PAD or our affiliates,
            licensors, or users, as applicable, and you agree not to take any
            action(s) inconsistent with such ownership interests. We and our
            affiliates, licensors, and users, as applicable, reserve all rights
            in connection with the Service and its content, including, without
            limitation, the exclusive right to create derivative works. GMX
            PAD’s name, logo, trademarks, and any GMX PAD product or service
            names, designs, logos, and slogans are the intellectual property of
            GMX PAD or our affiliates or licensors and may not be copied,
            ...
            “hidden text” utilizing “GMX PAD” or any other name, trademark or
            product or service name of GMX PAD or our affiliates or licensors
            ...
            trade dress of GMX PAD and may not be copied, imitated or used, in
            ...
            associated with any NFTs displayed on the Service are the property
            ...
            endorsement, sponsorship, or recommendation by GMX PAD. We welcome
            feedback, comments, and suggestions for improvements to the Service
            ...
            You agree that GMX PAD may use and disclose Feedback in any manner
            ...
            or other right or claim. You hereby assign to GMX PAD any and all
          ...
          <p>
            ...
            non-sublicensable, and personal license to access and use the
            ...
            or made available to you as part of your use of the Service, we
            hereby grant you a non-commercial, personal, non-assignable,
            ...
            provided to you as part of the Service (and right to download a
            single copy of the App onto your applicable equipment or device), in
            each case for the sole purpose of enabling you to use the Service as
            permitted by these Terms, provided that your license in any content
            linked to or associated with any NFTs is solely as set forth by the
          ...
          <br />
          <p>
            As a peer-to-peer web3 service, GMX PAD helps you explore NFTs
            created by third parties and interact with different blockchains.
            GMX PAD does not make any representations or warranties about this
            ...
            cannot guarantee that any NFTs visible on GMX PAD will always remain
            visible and/or available to be bought, sold, or transferred. NFTs
            may be subject to terms directly between buyers and sellers with
            respect to the use of the NFT content and benefits associated with a
            given NFT (“Purchase Terms”). For example, when you click to get
            more details about any of the NFTs visible on GMX PAD, you may
            ...
            required to comply with. GMX PAD is not a party to any such Purchase
            ...
            responsible for reviewing such Purchase Terms. The Service may also
            contain links or functionality to access or use third-party websites
            ...
            Materials are not under the control of GMX PAD, and may be “open”
            applications for which no recourse is possible. GMX PAD is not
            responsible or liable for any Third-Party Websites, Third-Party
            Applications, and Third-Party Materials. GMX PAD provides links to
          ...
          <br />
          <p className="text-[25px]">6.User Conduct</p>
          <br />
          <p>
            ...
            your ability to access our Service; and/or other actions. You agree
            that you will not violate any law, contract, intellectual property
            or other third-party right, and that you are solely responsible for
            your conduct and content, while accessing or using the Service. You
          ...
          <p>
            ...
            transaction on GMX PAD that is owned or controlled, in whole or in
            part, by any other person;
          </p>
          <p>
            {" "}
            • Claim an GMX PAD username for the purpose of reselling it,
          ...
          <p>
            {" "}
            • Sell or resell the Service or attempt to circumvent any GMX PAD
            fee systems;
          </p>
          <p>
            {" "}
            ...
            or other metrics that GMX PAD might use to sort search results;
          </p>
          <p>
            {" "}
          ...
          <p>
            ...
            applies to you or to GMX PAD;
          </p>
          <p>
            {" "}
            • Use the Service, directly or indirectly, for, on behalf of, or for
            the benefit of, (a) any natural or legal person that is the subject
            of Sanctions; (b) any natural or legal person located in, ordinarily
            resident in, or organized under the laws of, any Embargoed
            Jurisdiction; or (c) any legal person owned or controlled, directly
            or indirectly, by any natural or legal person located in, ordinarily
            resident in, or organized under the laws of, any Embargoed
            Jurisdiction.
          </p>
          <p>
          ...
          <p>
            ...
            search results. Finally, by using the Service, you understand the
            importance of DYOR – doing your own research. You bear full
            responsibility for verifying the authenticity, legitimacy, identity,
            and other details about any NFT, collection, or account that you
            view or otherwise interact with in conjunction with our Service. We
          ...
          <br />
          <p className="text-[25px]">7.Intellectual Property Rights</p>
          <br />
          <p>
            ...
            displaying content, or by complying with GMX PAD’s metadata
            ...
            Service. GMX PAD does not claim that submitting, posting, or
            displaying this content on or through the Service gives GMX PAD any
            ...
            otherwise legally entitled to post the material and to grant GMX PAD
            the license described above, and that the content does not violate
            any laws. GMX PAD will take down works in response to Digital
            Millennium Copyright Act (“DMCA”) takedown notices and/or other
            intellectual property infringement claims and will terminate a users
            access to the Service if the user is determined to be a repeat
            infringer. If you believe that your content has been copied in a way
            ...
            copyright agent at: GMX PAD Technologies, Inc. , partner@GMX PAD.io
            , 1309 Coffeen Avenue Ste, #1200, Wyoming, USA. For us to process
            ...
            rightsholder. We encourage you to use our form to help ensure the
            requisite information is included in your notice. If you choose to
            write to us by e-mail or physical mail instead, your notice must
            include:
          </p>
          <br />
          <p>
          ...
          <p> • A statement that the information in the notice is accurate;</p>
          <p>
            {" "}
            • A statement under penalty of perjury that you are authorized to
            act on behalf of the intellectual property owner of the intellectual
            property that is allegedly being infringed.
          </p>
          <p>
            {" "}
          ...
          <p>
            ...
            is no longer available on GMX PAD and can also contact you to
            resolve any dispute.
          </p>
          <br />
          <p className="text-[25px]">8.Communication Preferences</p>
          <br />
          <p>
            By creating an Account, you consent to receive electronic
            communications from GMX PAD (e.g., via email, push notification,
          ...
          <br />
          <p className="text-[25px]">9.App Terms</p>
          <br />
          <p>
            ...
            apply to you only if you are using the App from the Apple App Store:
            To the extent the other terms and conditions of these Terms are less
            ...
            GMX PAD, not Apple, and that Apple has no responsibility for the App
            or content thereof. Your use of the App must comply with the App
            ...
            Apple will refund the purchase price, if any, for the App to you. To
            ...
            solely governed by these Terms. You acknowledge that Apple is not
            responsible for addressing any claims of yours or any third party
            ...
            rights, GMX PAD, not Apple, will be solely responsible for the
            ...
            agreement when using the App. You acknowledge and agree that Apple,
          ...
          <br />
          <p className="text-[25px]">10.Indemnification</p>
          <br />
          <p>
            ...
            defend, and hold harmless GMX PAD, and our respective past, present,
            ...
            collectively, the “GMX PAD Parties”), from and against all actual or
            ...
            related to (a) your use or misuse of the Service, content, NFTs, or
            content linked to or associated with any NFTs (b) any Feedback you
            ...
            notify GMX PAD of any Claims and cooperate with the GMX PAD Parties
            in defending such Claims. You further agree that the GMX PAD Parties
          ...
          <p>
            ...
            INDEMNITIES SET FORTH IN A WRITTEN AGREEMENT BETWEEN YOU AND GMX
            PAD.
          </p>
          <br />
          <p className="text-[25px]">11.Disclaimers</p>
          <br />
          <p>
            ...
            “AS AVAILABLE” BASIS AND GMX PAD EXPRESSLY DISCLAIMS WARRANTIES OR
            CONDITIONS OF ANY KIND, EITHER EXPRESS OR IMPLIED. GMX PAD (AND ITS
            ...
            COMPLETE, LEGAL, OR SAFE. GMX PAD DISCLAIMS ALL OTHER WARRANTIES OR
            CONDITIONS, EXPRESS OR IMPLIED, INCLUDING, WITHOUT LIMITATION,
            IMPLIED WARRANTIES OR CONDITIONS OF MERCHANTABILITY, FITNESS FOR A
            PARTICULAR PURPOSE, TITLE AND NON-INFRINGEMENT. GMX PAD WILL NOT BE
            ...
            GMX PAD ATTEMPTS TO MAKE YOUR ACCESS TO AND USE OF THE SERVICE SAFE,
            GMX PAD CANNOT AND DOES NOT REPRESENT OR WARRANT THAT THE SERVICE,
            ...
            ADVICE OR INFORMATION, WHETHER ORAL OR OBTAINED FROM THE GMX PAD
            ...
            INTERNET AND WILL NOT HOLD GMX PAD RESPONSIBLE FOR ANY BREACH OF
            ...
            WITH NFTS, INCLUDING BUT NOT LIMITED TO ANY LOSSES, DAMAGES, OR
            ...
            ETHEREUM). GMX PAD AND/OR ANY OTHER GMX PAD PARTY CANNOT EFFECT OR
            OTHERWISE CONTROL THE TRANSFER OF TITLE OR RIGHT IN ANY NFTS OR
            UNDERLYING OR ASSOCIATED CONTENT OR ITEMS. NO GMX PAD PARTY IS
            ...
            THE NFTS. NO GMX PAD PARTY IS RESPONSIBLE FOR LOSSES OR INJURY DUE
          ...
          <br />
          <p className="text-[25px]">12.Assumption of Risk</p>
          <br />
          <p>
            You accept and acknowledge: • The value of an NFTs is subjective.
            Prices of NFTs are subject to volatility and fluctuations in the
            price of cryptocurrency can also materially and adversely affect NFT
            prices. You acknowledge that you fully understand this subjectivity
            and volatility and that you may lose money. • A lack of use or
            public interest in the creation and development of distributed
            ecosystems could negatively impact the development of those
            ecosystems and related applications, and could therefore also
            negatively impact the potential utility of NFTs. • The regulatory
            regime governing blockchain technologies, non-fungible tokens,
            cryptocurrency, and other crypto-based items is uncertain, and new
            ...
            amounts of taxes to the appropriate tax authorities. GMX PAD is not
            ...
            interact with any NFTs or accounts/collections. • We do not control
            the public blockchains that you are interacting with and we do not
            ...
            and GMX PAD has no ability to reverse any transactions on the
            ...
            Account. You accept and acknowledge that GMX PAD will not be
            ...
            third-party platforms and/or vendors. If we are unable to maintain a
            good relationship with such platform providers and/or vendors; if
            the terms and conditions or pricing of such platform providers
            and/or vendors change; if we violate or cannot comply with the terms
            ...
            the Service will suffer. • GMX PAD reserves the right to hide
            collections, contracts, and items affected by any of these issues or
            by other issues. Items you purchase may become inaccessible on GMX
            PAD. Under no circumstances shall the inability to view items on GMX
            PAD or an inability to use the Service in conjunction with the
            purchase, sale, or transfer of items available on any blockchains
            serve as grounds for a claim against GMX PAD. • If you have a
          ...
          <p>
            ...
            WILL GMX PAD OR ITS SERVICE PROVIDERS BE LIABLE TO YOU OR ANY THIRD
            ...
            FORESEEABLE AND EVEN IF GMX PAD OR ITS SERVICE PROVIDERS HAVE BEEN
            ...
            OF GMX PAD ARISING OUT OF OR IN ANY WAY RELATED TO THESE TERMS, THE
            ACCESS TO AND USE OF THE SERVICE, CONTENT, NFTS, OR ANY GMX PAD
            PRODUCTS OR SERVICES EXCEED THE GREATER OF (A) $100 OR (B) THE
            AMOUNT RECEIVED BY GMX PAD FOR ITS SERVICE DIRECTLY RELATING TO THE
          ...
          <br />
          <p className="text-[25px]">15.Modifications to the Service</p>
          <br />
          <p>
          ...
          <br />
          <p className="text-[25px]">16.Dispute Resolution; Arbitration</p>
          <br />
          <p>
            • Dispute Resolution. Please read the following arbitration
            agreement in this Section (“Arbitration Agreement”) carefully. It
            requires you to arbitrate disputes with GMX PAD and limits the
            ...
            GMX PAD does not provide dispute resolution services for such
            ...
            Service, or to any aspect of your relationship with GMX PAD, will be
            resolved by binding arbitration, rather than in court, including
            threshold questions of the arbitrability of such dispute,
            controversy, or claim except that (1) you or GMX PAD may assert
            ...
            GMX PAD may seek injunctive or equitable relief in a court of proper
            jurisdiction if the claim relates to intellectual property
            infringement or other misuse of intellectual property rights. •
            Dispute resolution process. You and GMX PAD both agree to engage in
            ...
            describing the nature of your claim and desired resolution to: GMX
            PAD, Attn: Legal Department, 1309 Coffeen Avenue Ste, #1200,
            Wyoming, USA. Both parties agree to meet and confer personally, by
            telephone, or by videoconference (hereinafter “Conference”) to
            ...
            fully participate in the Conference. Likewise, if GMX PAD is
            represented by counsel, its counsel may participate in the
            Conference as well, but GMX PAD agrees to have a company
            ...
            infringement, if the claims qualify. • Authority of Arbitrator. The
            ...
            decide the rights and liabilities, if any, of you and GMX PAD. The
            ...
            binding upon you and us. • Waiver of Jury Trial. YOU AND GMX PAD
            HEREBY WAIVE ANY CONSTITUTIONAL AND STATUTORY RIGHTS TO SUE IN COURT
            AND HAVE A TRIAL IN FRONT OF A JUDGE OR A JURY. You and GMX PAD are
            ...
            very limited review. • Waiver of Class Actions and Class
            Arbitrations. ALL CLAIMS AND DISPUTES WITHIN THE SCOPE OF THIS
            ARBITRATION AGREEMENT MUST BE ARBITRATED ON AN INDIVIDUAL BASIS AND
            NOT ON A REPRESENTATIVE (INCLUDING, WITHOUT LIMITATION, PAGA) OR
            ...
            generality of the foregoing, you and GMX PAD agree that no dispute
            ...
            relationship with GMX PAD. • Modification. Notwithstanding any
            provision in these Terms to the contrary, we agree that if GMX PAD
            makes any future material change to this Arbitration Agreement, you
            may reject that change within thirty (30) days of such change
            becoming effective by writing to GMX PAD at the following address:
            GMX PAD, Attn: Legal Department, 1309 Coffeen Avenue Ste, #1200,
            Wyoming, USA.
          </p>
          <br />
          ...
          <p>
            ...
            of the State of Wyoming (without regard to conflict of law rules or
            principles of the State of Wyoming, or any other jurisdiction that
            ...
            shall be resolved in the state or federal courts of Wyoming in the
            State of Wyoming, and the United States.
          </p>
          <br />
          <p className="text-[25px]">18.Termination</p>
          <br />
          <p>
            If you breach any of the provisions of these Terms, all licenses
            granted by GMX PAD will terminate automatically. Additionally,
          ...
          <br />
          <p className="text-[25px]">19.Severability</p>
          <br />
          <p>
          ...
          <br />
          <p className="text-[25px]">20.Injuctive Relief</p>
          <br />
          <p>
            You agree that a breach of these Terms will cause irreparable injury
            to GMX PAD for which monetary damages would not be an adequate
            remedy and GMX PAD shall be entitled to equitable relief in addition
            to any remedies it may have hereunder or at law without a bond,
            other security, or proof of damages.
          </p>
          <br />
          <p className="text-[25px]">21.Export Laws</p>
          <br />
          <p>
            You agree that you will not export or re-export, directly or
            indirectly, the Service, and/or other information or materials
            provided by GMX PAD hereunder, to any country for which the United
          ...
          <br />
          <p className="text-[25px]">22.Survival</p>
          <br />
          <p>
            ...
            and notwithstanding any termination of these Terms by GMX PAD or
            you. Termination will not limit any of GMX PAD’s other rights or
            remedies at law or in equity.
          </p>
          <br />
          <p className="text-[25px]">23.Miscellaneous</p>
          <br />
          <p>
            These Terms constitute the entire agreement between you and GMX PAD
            ...
            assigned by you without the prior written consent of GMX PAD, and
            GMX PAD’s failure to assert any right or provision under these Terms
            ...
            read to have any legal effect. The Service is operated by us in the
            United States. Those who choose to access the Service from locations
            outside the United States do so at their own initiative and are
            responsible for compliance with applicable local laws. You and GMX
            PAD agree that the United Nations Convention on Contracts for the
            International Sale of Goods will not apply to the interpretation or
            construction of these Terms. Except as otherwise provided herein,
