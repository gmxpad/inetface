      ...
      <div className="flex w-full  text-white  justify-center sm:mt-14">
        <div className="sm:p-5 px-[10%] text-[20px]">
          ...
          <p>
            ...
            your wallet secure and you should never share your wallet
            ...
            Service or your Account (you can contact us via social@gamexpad.io).
            ...
            jurisdiction that is subject to a comprehensive U.S. Government
          ...
          <p>
            ...
            of the rightsholder. We encourage you to use our form to help ensure
            the requisite information is included in your notice. If you choose
            to write to us by e-mail or physical mail instead, your notice must
            include:
          </p>
          <br />
          <p>
          ...
          <p>
            ...
            INDEMNITIES SET FORTH IN A WRITTEN AGREEMENT BETWEEN YOU AND GAME X
            PAD.
          </p>
          <br />
          ...
          <p>
            ...
            describing the nature of your claim and desired resolution to: GAME
            X PAD, Attn: Legal Department, 1309 Coffeen Avenue Ste, #1200,
          ...
          <br />
          <p>
            These Terms constitute the entire agreement between you and GAME X
