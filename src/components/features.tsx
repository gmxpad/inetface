  ...
  const SLIDES = [
    {
      image: "/icons/ido.png",
      name: "IPO",
      desx: "Provide funding for WEB2 game projects and offers investors the opportunity to share in the revenue generated by the games.",
      link: "/",
    },
    {
      image: "/icons/ino.png",
      name: "INO",
      desx: "Offer a streamlined and transparent fundraising solution tailored for Web2 game projects. Each NFT represents a unique share of projects",
      link: "/",
    },
    {
      image: "/icons/nftmarket.png",
      name: "NFT Marketplace",
      desx: "Enables users to trade NFTs representing shares acquired through Initial Publisher Offerings (IPOs)",
      link: "/",
    },
    {
      image: "/icons/hub.png",
